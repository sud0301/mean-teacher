...
def main(context):
    ...
    train_loader, eval_loader = create_data_loaders( args=args)
...
def train(train_loader, model, ema_model, optimizer, epoch, log):
    ...
    for i, ((input, ema_input), target) in enumerate(train_loader):
        ...
        #class_logit = Variable(class_logit.cuda())
        #ema_logit = Variable(ema_logit.cuda())
        #target_var = Variable(target_var.cuda())
    ...
    for i, (input, target) in enumerate(eval_loader):
        ...
        if i % args.print_freq == 0:
            ...
            print (
                ...
                'Time {meters[batch_time]:.3f}\t'
                'Data {meters[data_time]:.3f}\t'
                'Class {meters[class_loss]:.4f}'.format(
                    i, len(eval_loader), meters=meters))
